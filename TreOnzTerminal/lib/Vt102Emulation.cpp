...
void Vt102Emulation::processWindowAttributeChange()
{
  ...
  QString newValue = QString::fromWCharArray(&tokenBuffer[i + 1], length);
...
void Vt102Emulation::sendKeyEvent( QKeyEvent* event )
{
    ...
    KeyboardTranslator::Entry entry = _keyTranslator->findEntry(
        ...
        {
            QString text = QString::fromUtf8(entry.text(true, modifiers));
...
char Vt102Emulation::eraseChar() const
{
  KeyboardTranslator::Entry entry = _keyTranslator->findEntry(
                                            Qt::Key_Backspace,
                                            Qt::NoModifier, Konsole::KeyboardTranslator::NoState);
