                                       ...
                                       const Character* style)
{
    ...
    if ( backgroundColor != palette().color(QPalette::Window) )
...
void TerminalDisplay::paintEvent( QPaintEvent* pe )
{
  ...
  else
  {
      ...
      {
        drawBackground(paint, rect, palette().color(QPalette::Window),
...
void TerminalDisplay::wheelEvent( QWheelEvent* ev )
{
  ...
  else
  {
    ...
    int charLine;
    int charColumn;
    QPoint p(qRound(ev->position().x()), qRound(ev->position().y()));
    getCharacterPosition(p, charLine, charColumn);
