...
void Emulation::setCodec(/*const QStringConverter * qtc*/ QStringConverter::Encoding encoding)
{
    // if(_codec)
    // {
    //     delete _codec;
    // }
    // _codec = new QStringConverter(encoding);
    ...
    _decoder = new QStringDecoder(encoding);
    ...
    _encoder = new QStringEncoder(encoding);
...
void Emulation::receiveData(const char* text, int length)
{
    ...
    QString utf16Text = (*_decoder)(QByteArrayView(text, length));
